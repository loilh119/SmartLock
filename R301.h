...
static uint8_t ValidTempNum[12]  = {0xEF,0x01,0xFF,0xFF,0xFF,0xFF,COMMAND,0x00,0x03,TempleteNum,0x00,0x21};
static uint8_t GenerateTemp[12]  = {0xEF,0x01,0xFF,0xFF,0xFF,0xFF,COMMAND,0x00,0x03,RegModel,0x00,0x09};
static uint8_t StoreTemp1[15]    = {0xEF,0x01,0xFF,0xFF,0xFF,0xFF,COMMAND,0x00,0x06,Store,CharBuffer1,0x00,0x00,0x00,0x0E};
static uint8_t StoreTemp2[15]    = {0xEF,0x01,0xFF,0xFF,0xFF,0xFF,COMMAND,0x00,0x06,Store,CharBuffer2,0x00,0x00,0x00,0x0F};
